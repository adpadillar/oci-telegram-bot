        ...
        <div className="flex items-center justify-between h-full px-3 sm:px-4 md:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg sm:text-xl font-semibold text-gray-800 hidden sm:inline-block">TaskFlow</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button className="p-2 rounded-full text-gray-500 hover:bg-gray-100 relative" aria-label="Notifications">
              <Bell size={18} />
